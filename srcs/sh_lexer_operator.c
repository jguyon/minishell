...
/*   Updated: 2017/04/06 17:45:00 by jguyon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_operators(t_sh_operator *ops[1])
{
	size_t	i;
...
size_t			remove_operators(t_sh_operator *ops[1], char c, size_t curr)
{
	size_t	i;
	size_t	count;
...
int				find_operator(t_sh_operator *ops[1], size_t curr,
					t_sh_token *tok)
{
	size_t	i;
